...
A kids' fashion dress-up game — **beta**.

**Play:** https://amydesignn.github.io/Cozy-closet-game/

## The house

- **Amy** — direction
- **Finn** — brief
- **Oscar** — design + prototype
- **Nathan** — production + deploy
...
GitHub Pages; a Poki-packaged build follows later.
